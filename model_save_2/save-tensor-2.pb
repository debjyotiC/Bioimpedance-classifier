...
node {
  name: "gradients/output_layer_grad/mul"
  op: "Mul"
...
node {
  name: "gradients/output_layer_grad/Sum/reduction_indices"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/output_layer_grad/Sum"
  op: "Sum"
  input: "gradients/output_layer_grad/mul"
  input: "gradients/output_layer_grad/Sum/reduction_indices"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/output_layer_grad/sub"
  op: "Sub"
  input: "gradients/AddN_1"
  input: "gradients/output_layer_grad/Sum"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/output_layer_grad/mul_1"
  op: "Mul"
  input: "gradients/output_layer_grad/sub"
  input: "output_layer"
  attr {
    key: "T"
    value {
...
node {
  ...
  op: "Sum"
  input: "gradients/output_layer_grad/mul_1"
...
node {
  name: "GradientDescent/update_w4/ApplyGradientDescent"
  op: "ApplyGradientDescent"
  input: "w4"
  input: "GradientDescent/learning_rate"
...
node {
  name: "GradientDescent/update_b4/ApplyGradientDescent"
  op: "ApplyGradientDescent"
  input: "b4"
  input: "GradientDescent/learning_rate"
...
node {
  ...
  input: "^GradientDescent/update_b4/ApplyGradientDescent"
  ...
  input: "^GradientDescent/update_w4/ApplyGradientDescent"
}
node {
  name: "ArgMax/input"
  op: "Const"
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\000\000\000\000\000\000\360?\000\000\000\000\000\000\000@"
      }
    }
  }
}
